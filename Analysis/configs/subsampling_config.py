...
subsampling_config_2_channel = {
	'offset': int(0 * FRAME_TO_MS_2),  # offset of subsampling, in frames (1s in this eg.) 偏移量
	'duration': int(10000 * FRAME_TO_MS_2),  # maximun length of subsampling range, in frames 持续时间
