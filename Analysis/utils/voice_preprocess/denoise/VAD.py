...
# based on py-webrtcvad, see https://github.com/wiseman/py-webrtcvad
...
def main(*args):
	if len(args) != 3:
		sys.stderr.write(
			'Usage: example.py <aggressiveness> <path to wav file> <destined directory>\n')
		sys.exit(1)
	...
	for i, segment in enumerate(segments):
		path = os.path.join(args[2], 'chunk-%002d.wav' % (i,))
